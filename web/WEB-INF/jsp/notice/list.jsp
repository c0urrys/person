  ...
  <body>
      ...
      <span class="layui-breadcrumb">
        ...
        <a>
         ...
         <button id="bbb" type="button"  onclick="location.href='${pageContext.request.contextPath}/notice/toadd'" class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:innert;margin-left:75%;;"  ><i class="layui-icon"></i>增加</button>
          <a id="aaa" class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="${ctx }/notice/list" title="刷新">
    ...
    <div class="x-body">
     ...
     <tr>
            ...
            <td>${dept.username}</td>
            <td class="td-manage" >
               <a title="编辑"  href='${pageContext.request.contextPath}/notice/toedit?id=${dept.id}'>
