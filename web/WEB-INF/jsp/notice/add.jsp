        ...
        <input type="hidden" name="user_id" id="user_id" value="${sessionScope.user_session.id}" >
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                ...
                placeholder="不少于2个字符"  autocomplete="off" class="layui-input" value="${notice.title }">
              </div>
          ...
          <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <textarea placeholder="请输入内容，不少于5个字符" id="content" name="content" class="layui-textarea">${notice.content }</textarea>
                    </div>
                </div>
          ...
          <div class="layui-form-item">
              ...
              <input type="button" value=" 公告列表" class="layui-btn"  id="ret"/>
          </div>
      </form>
    </div>
    <script>
