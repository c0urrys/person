    ...
    <div class="x-body">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="title" name="title" required="" lay-verify="required"
                   placeholder="不少于3个汉字" autocomplete="off" class="layui-input" value="${data.title }">
              </div>
        ...
        <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  placeholder="不少于5个汉字"  autocomplete="off" class="layui-input" value="${data.remark}">
              </div>
