...
<html>
  ...
  <body>
    <div class="x-nav">
      ...
      <a  class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="${pageContext.request.contextPath}/train/totrain" title="刷新">
    ...
    <div class="x-body">
     ...
     <div style="margin-left: 400px;" id="count1">
         <fkjava:pager
	  	        ...
	  	        style="digg"
	  	        submitUrl="${pageContext.request.contextPath}/train/trainlist?pageIndex={0}"/>
     </div>
    ...
    <script>
      ...
      function member_del(obj,id){
          layer.confirm('确认要删除吗？',function(index){
              //发异步删除数据
              //等以后再使用异步，这里先使用
              $.get("${pageContext.request.contextPath}/checkwork/leavedelete?id="+id);
