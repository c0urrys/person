...
$(function(){
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" method="POST" id="deptForm"  action="${pageContext.request.contextPath}/checkwork/pedit">
        <input type="hidden" name="id" id="id" value="${checkwork.id }" >
          <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${checkwork.employeename}">
            ...
            <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${checkwork.jobname}">
            ...
            <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${checkwork.deptname}">
