        ...
        <input type="hidden" name="id" id="id" value="${checkwork.id }" >
          <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  <input type="text" id="employee_name" name="employeename" required="" lay-verify="required"  readonly ="readonly"  
                  ...
                  <select id="job_id" name="jobId" class="valid" disabled="disabled">
                    <option value="0">--部门选择--</option>
						   <c:forEach items="${requestScope.job_list}" var="job">
						   		<c:choose>
			    					<c:when test="${checkwork.job_id == job.id }">
                  ...
                  <select  name="deptId" class="valid" disabled="disabled">
                      <option value="0">--部门选择--</option>
						   <c:forEach items="${requestScope.dept_list}" var="dept">
						   		<c:choose>
			    					<c:when test="${checkwork.dept_id == dept.id }">
