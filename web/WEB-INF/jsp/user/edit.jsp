...
<html>
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" method="POST" id="deptForm"  action="${pageContext.request.contextPath}/user/checkedit">
        ...
        <%-- <input type="hidden" name="email" id="email" value="${user.email }" > --%>
         ...
         <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <select  name="status_id" class="valid">
						   <c:forEach items="${status_list}" var="status">
						   		<c:choose>
			    					<c:when test="${user.status_id == status.id }">
          ...
          <div class="layui-form-item" >
              <label for="username" class="layui-form-label">
                  <span class="x-red">*</span>关联员工
              </label>
              <div class="layui-input-inline">
               <select id="emp_id" name="emp_id" class="valid">
        			<c:forEach items="${emp_list}" var="emp">
	        			<c:choose>
	        				<c:when test="${user.emp_id == emp.id }">
