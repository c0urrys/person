...
<html>
  ...
  <head>
    ...
    $(function(){
    	$("#deptForm").submit(function(){
    		...
    		var msg = "";
    		if (!/^[A-Za-z0-9]{2,15}$/.test($.trim(loginname.val()))){
    			msg = "登录名格式不正确！5-15个英文字母";
    			loginname.focus(); 
    		}
    		 else if (!/^[\u4E00-\u9FA5]{2,6}$/.test($.trim(username.val()))){
    			msg = "用户名格式不正确！！！姓名";
    			username.focus(); 
    	    }
  ...
  <body>
    <div class="x-body">
        ...
        <input type="hidden" name="id" id="id" value="${user_session.id }" >
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${user_session.loginname }">
              </div>
         ...
         <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${user_session.username }">
              </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${user_session.email}">
              </div>
