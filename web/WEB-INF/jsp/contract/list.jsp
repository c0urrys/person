  ...
  <body>
    ...
    <div class="x-body">
     <div class="layui-row" style="" align="center">
       <form class="layui-form layui-col-md12 x-so" method="get" action="${pageContext.request.contextPath}/contract/list">
     ...
     <tr>
            <td>
              <div class="layui-unselect layui-form-checkbox" lay-skin="primary" data-id='2'><i class="layui-icon">&#xe605;</i></div>
					  ...
					  <td>
					        <c:choose>
					        	<c:when test="${contract.train_contract == 1}">已签</c:when>
					   ...
					   <td>
					     <c:choose>
					        	<c:when test="${contract.labor_contract == 1}">已签</c:when>
					        	<c:otherwise><a><font color="red">未签</font></a></c:otherwise>
					        </c:choose>
					   ...
					   <td>
					     <c:choose>
					        	<c:when test="${contract.confidentiality_contract == 1}">已签</c:when>
					        	<c:otherwise><a><font color="red">未签</font></a></c:otherwise>
					        </c:choose>
