	...
	<div class="x-body">
		<div class="layui-row" style="" align="center">
			<form class="layui-form layui-col-md12 x-so" method="get"
				...
				<input type="text" name="content" style="width: 50%;" value="${content}"
				...
				<c:forEach items="${requestScope.list}" var="dept" varStatus="stat">
					<tr>
						...
						<td class="td-manage"><a title="编辑"
							href='${pageContext.request.contextPath}/dept/toedit?id=${dept.id}'>
								<i class="layui-icon">&#xe642;</i>
		...
		<div style="margin-left: 400px;">
			<fkjava:pager pageIndex="${requestScope.pageModel1.pageIndex}"
				pageSize="${requestScope.pageModel1.pageSize}"
				recordCount="${requestScope.pageModel1.recordCount}" style="digg"
