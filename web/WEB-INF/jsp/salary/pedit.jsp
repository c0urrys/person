...
$(function(){
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" method="POST" id="deptForm"  action="${pageContext.request.contextPath}/salary/pedit">
        <input type="hidden" name="id" id="id" value="${salary.id }" >
          <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${salary.employeename}">
