        ...
        <input type="hidden" name="id" id="id" value="${job.id }" >
          <div class="layui-form-item" >
           ...
           <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${job.salary_station}">
              </div>
          ...
          <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${job.salary_level}">
              </div>
          ...
          <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${job.seniority_pay}">
              </div>
            ...
            <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${job.individual_income}">
              </div>
          </div>
          <div class="layui-form-item">
