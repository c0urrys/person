...
<div style="width: 1360px;height:48px; background-color:RGB(43,48,59) ">
      <ul style="margin-left: 40px;padding-top:6px">
        <li style="display: inline-block;"><h1><a href="loginForm.jsp" style="color:white;font-size:20px;">创新创业型小微企业的人力资源管理平台</a></h1></li>
    ...
    <div id="main" style="width:1360px;height:610px;float:left;">
		...
		<div class="register" style="height:360px;margin-top:150px;margin-left:205px; opacity:0.9;">
           ...
           <form action="${pageContext.request.contextPath}/setPassword" method="post" id="toPasswordForm">
               <div style="height: 10px"></div>
               <div class="default">
                    <input id="loginname" name="loginname"   data-form="upwd" type="text" placeholder="请输入您的登录名 "  value="${loginname }" readonly="readonly" />
               </div>
               ...
               <div class="default" style="margin-top: 16px;">
                    <input id="password" name="password" data-form="uname" type="password" placeholder="新密码  6-16位数字和字母的组合" value="" onchange="check_register_password1()"/>
             </div>
              ...
              <div class="default" style="margin-top: 16px;">
                    <input id="repassword" name="repassword" data-form="uname" type="password" placeholder="请再次输入你的新密码"  value="" onchange="check_register_repassword1()"/>
             </div>
              <div style="height: 10px;margin-top: -10px;">
             ...
             <div style="height: 10px"></div>
             <div class="submit">
                  <input type="button" value="找回" onclick="tofind()">
             </div>
