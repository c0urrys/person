...
<div style="width: 1600px;height:48px; background-color:RGB(43,48,59) ">
      <ul style="margin-left: 40px;padding-top:6px">
        <li style="display: inline-block;"><h1><a href="${pageContext.request.contextPath }/tologin" style="color:white;font-size:20px;">创新创业型小微企业的人力资源管理平台</a></h1></li>
        <li style="display: inline-block; margin-left: 120px;"><a  style="font-size:14px;color:rgb(130,130,130); " >用户登陆</a></li>
        <li style="display: inline-block; margin-left: 60px;"><a href="${pageContext.request.contextPath }/tologin" style="font-size:14px;color:rgb(130,130,130); ">首页</a></li>
        <li style="display: inline-block; margin-left: 80px;"><a href="${pageContext.request.contextPath }/tologin"	  style="font-size:14px;color:rgb(130,130,130); ">帮助与文档</a></li>
		 ...
		 <div id="register"  class="register" style="height:370px;margin-top:150px;margin-left:325px;opacity:0.9;">
            ...
            <form  method="post" action="${pageContext.request.contextPath}/login" name="check-form" id="toLoginForm"> 
                ...
                <div class="default" style="margin-top:40px;">
                    <input 	data-form="uname" type="text" placeholder="请输入登录名"  onchange="tocheckLoginname()"  id="loginname" name="loginname" value="${loginname}"/>
                </div>
                ...
                <div class="default">
                    <input id="password" name="password"
									value="" data-form="upwd" type="password" placeholder="请输入账号密码 " />
                </div>
              ...
              <div class="default" >
                ...
                <div class="submit" style="margin-top: 12px;"> 
                        ...
                        <span class="notice">
                          ...
                          <a id="repassword" href="javascript:;" onclick="toRepassword()">忘记密码</a>
                        </span>
