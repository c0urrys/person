    ...
    <div class="x-body">
        ...
        <input type="hidden" name="id" id="id" value="${employee.id }" >
          ...
          <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  <input type="text" id="card_id" name="card_id" required="" lay-verify="required"   disabled="disabled"
                  autocomplete="off" class="layui-input" value="${employee.educationname }">
              </div>
          </div>
          ...
          <div class="layui-form-item">
           ...
           <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  <input type="text" id="card_id" name="card_id" required="" lay-verify="required"   disabled="disabled"
                  autocomplete="off" class="layui-input" value="${employee.jobname }">
              </div>
          </div>
          ...
          <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  <input type="text" id="card_id" name="card_id" required="" lay-verify="required"   disabled="disabled"
                  autocomplete="off" class="layui-input" value="${employee.deptname }">
              </div>
          </div>
