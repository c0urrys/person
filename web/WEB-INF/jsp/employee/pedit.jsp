...
<html>
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" method="POST" id="deptForm"  action="${pageContext.request.contextPath}/employee/pedit">
        <input type="hidden" name="id" id="id" value="${employee.id}" >
          ...
          <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  <input type="text" id="cardId" name="card_id" required="" lay-verify="required"  disabled="disabled"
