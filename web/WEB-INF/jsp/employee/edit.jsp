            ...
            <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
               <select id="sex_id" name="sexId" class="valid">
                  			<c:forEach items="${sex_list}" var="sex">
						   		<c:choose>
			    					<c:when test="${employee.sex_id== sex.id }">
             ...
             <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
               <select id="education_id" name="education_id" class="valid">
                  			<c:forEach items="${education_list}" var="edu">
						   		<c:choose>
			    					<c:when test="${employee.education_id== edu.id }">
